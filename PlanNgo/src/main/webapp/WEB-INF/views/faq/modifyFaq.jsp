	...
	<div class="container">
		...
		<div class="portfolio-grids">
			<table summary="글쓰기 전체 테이블">
				<form name="join" method="post" action="modifyFaq" onsubmit="return formCheck();">
					...
					<table class="table-form" summary="테이블 구성">
						...
						<input type="hidden" name="FAQCODE" value="${faqVO.FAQCODE}">
						
						<tr>
							<td>제 목</td>
							<td><input type="text" name="FAQTITLE"  id= "FAQTITLE" cols="130" value="${faqVO.FAQTITLE}"></td>
							<%-- <c:if test="${errors.FAQTITLE}">제목을 입력하세요.</c:if> --%>
						</tr>
						<tr>
							<td>내 용</td>
							<td><textarea name="FAQCONTENT"  id= "FAQCONTENT"  rows="10" cols="130"  value="${faqVO.FAQCONTENT}">${faqVO.FAQCONTENT}</textarea></td>
						</tr>
					...
					<td colspan="2"><div align="center">
						...
						<input type="button"  id ="saveBtn"  value="수정" class="btn btn-default">&nbsp;&nbsp;
